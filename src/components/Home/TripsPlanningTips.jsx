  ...
  return (
    <div className="backGround">
      ...
      <ol className="tipsList">
        <li>
          Decide on your destination: Consider your interests, budget, and time
          available to choose a destination that suits your preferences.
        </li>
        <li>
          Set a budget: Determine how much you're willing to spend on your trip,
          including accommodations, transportation, meals, activities, and
          souvenirs.
        </li>
        <li>
          Research the best time to visit: Look into the climate, peak tourist
          seasons, and any special events or festivals that may be happening at
        ...
        <li>
          ...
          budget and preferences. Consider factors such as location, amenities,
        ...
        <li>
          ...
          using ride-sharing services. Research local transportation options in
          advance.
        </li>
        <li>
          Pack smart: Make a packing checklist based on the weather, activities,
          and duration of your trip. Pack essentials, including clothes,
          toiletries, medications, and any necessary travel documents.
        </li>
        <li>
        ...
        <li>
          ...
          protect yourself against unexpected events such as trip cancellations,
          medical emergencies, or lost baggage.
        </li>
        <li>
        ...
        <li>
          Learn basic local phrases: Familiarize yourself with common greetings
          and phrases in the local language. It can enhance your travel
          experience and help you communicate with locals.
        </li>
        <li>
        ...
        <li>
          Inform your bank and mobile service provider: Let your bank know about
          your travel plans to avoid any issues with your cards. Check
